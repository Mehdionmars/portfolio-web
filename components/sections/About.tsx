        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="space-y-4">
              <h3 className="text-2xl font-semibold">One word which drives me - "Curiosity"</h3>
          ...
          <motion.div
            ...
            className="space-y-6"
          >
            <Card className="border-2 border-blue-100 dark:border-blue-900/20 hover:border-blue-300 dark:hover:border-blue-700 transition-colors">
            ...
            <Card className="border-2 border-teal-100 dark:border-teal-900/20 hover:border-teal-300 dark:hover:border-teal-700 transition-colors">
              <CardContent className="p-6">
                <div className="flex items-center space-x-3 mb-4">
                  <div className="p-2 bg-teal-100 dark:bg-teal-900/20 rounded-lg">
                    <Heart className="w-5 h-5 text-teal-600" />
                  </div>
                  <h4 className="font-semibold">Passion Projects</h4>
                </div>
                <p className="text-sm text-muted-foreground">
            ...
            <Card className="border-2 border-purple-100 dark:border-purple-900/20 hover:border-purple-300 dark:hover:border-purple-700 transition-colors">
              <CardContent className="p-6">
                <div className="flex items-center space-x-3 mb-4">
