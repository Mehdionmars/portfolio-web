    ...
    return (
        <div className="w-full max-w-6xl mx-auto px-4">
            <div className="text-center space-y-6 mb-16">
                ...
                <p className="font-handwritten text-xl text-zinc-600 dark:text-teal-500 rotate-[-1deg]">
                    {description}
                </p>
            </div>
                    ...
                    >
                        ...
                        <div className="relative p-6">
                            ...
                            <div className="mb-6">
                                ...
                                <p className="font-handwritten text-blue-600 dark:text-blue-600">
                                    {tier.description}
                                </p>
                            </div>
